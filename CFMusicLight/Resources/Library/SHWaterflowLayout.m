...
@implementation SHWaterflowLayout
...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        self.rowMargin = 10;
        self.sectionInset = UIEdgeInsetsMake(0, self.columnMargin, 0, self.columnMargin);
        self.columnsCount = 4;
    }
    return self;
}
