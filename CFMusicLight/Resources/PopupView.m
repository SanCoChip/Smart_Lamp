...
- (void) setIndex:(NSString *) text
{
    ...
    _textLabel.textColor = [UIColor whiteColor];
    self.backgroundColor = [[UIColor lightGrayColor] colorWithAlphaComponent: 0.05f];
...
- (void) setWarning:(NSString *) text
{
    ...
    _textLabel.textColor = [UIColor whiteColor];
    self.backgroundColor = [[UIColor lightGrayColor] colorWithAlphaComponent: 0.9f];
